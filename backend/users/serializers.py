...
class ClientRegisterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = User
        fields = ['email', 'username', 'password', 'confirm_password', 'phone']
...
class UserListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = User
        fields = ['id', 'email', 'username', 'role', 'phone', 'is_active', 'created_at']
...
class ArchitectRegisterSerializer(serializers.Serializer):
    """Architect registers via invite token"""
